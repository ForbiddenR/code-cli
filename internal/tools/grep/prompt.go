...
const (
	// ToolName is the model-facing local search tool name.
	ToolName = "Grep"

	// ToolPrompt is the exact model-facing GrepTool description.
	ToolPrompt = "A powerful search tool built on ripgrep\n\n" +
		"  Usage:\n" +
